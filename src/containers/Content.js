...
export default ({button, id, preview, onClick, translate, sort, srcSet}) => {
    if (unDef(onClick)) {
    ...
    const title = translate(`theme_selector.${id}.title`);
    const description = translate(`theme_selector.${id}.description`);
    return (
